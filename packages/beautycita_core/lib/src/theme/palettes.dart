...
const kGoldPositions = [
  0.0, 0.08, 0.15, 0.25, 0.35, 0.45, 0.50, 0.58, 0.68, 0.78, 0.85, 0.93,
  1.0,
];
...
const glassmorphismPalette = BCPalette(
  ...
  cinematicGradient: [
    Color(0xFFEC4899), Color(0xFF9333EA), Color(0xFF3B82F6),
  ],
  statusBarColor: Color(0x00000000),
  statusBarIconBrightness: Brightness.light,
...
const midnightOrchidPalette = BCPalette(
  ...
  cinematicGradient: [
    Color(0xFF7B1FA2), Color(0xFFB388FF), Color(0xFFE040FB),
    Color(0xFFFF80AB),
  ],
  statusBarColor: Color(0x00000000),
  statusBarIconBrightness: Brightness.light,
...
const oceanNoirPalette = BCPalette(
  ...
  cinematicGradient: [
    Color(0xFF006978), Color(0xFF00E5FF), Color(0xFF1DE9B6),
    Color(0xFFE0F7FA),
  ],
  statusBarColor: Color(0x00000000),
  statusBarIconBrightness: Brightness.light,
...
const cherryBlossomPalette = BCPalette(
  ...
  cinematicGradient: [
    Color(0xFFBE185D), Color(0xFFFF6B9D), Color(0xFFC084FC),
    Color(0xFFFFF5F7),
  ],
  statusBarColor: Color(0x00000000),
  statusBarIconBrightness: Brightness.dark,
