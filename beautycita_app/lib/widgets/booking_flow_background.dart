...
String? categoryIdFromServiceType(String serviceType) {
  ...
  const prefixMap = <String, String>{
    ...
    'lash': 'lashes_brows',
    'brow': 'lashes_brows',
    'ext_pestana': 'lashes_brows',
    'extension_pestana': 'lashes_brows',
    'lifting_pestana': 'lashes_brows',
    'tinte_pestana': 'lashes_brows',
    'tinte_ceja': 'lashes_brows',
    'relleno_pestana': 'lashes_brows',
    'retiro_pestana': 'lashes_brows',
    'combo_': 'lashes_brows',
    'henna_cejas': 'lashes_brows',
    'diseno_depilacion': 'lashes_brows',
    'laminado': 'lashes_brows',
    'micropigmentacion_cejas': 'lashes_brows',
    'masaje': 'body_spa',
    'depilacion': 'body_spa',
    'body': 'body_spa',
    'maquillaje': 'makeup',
