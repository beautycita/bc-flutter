...
const _termsSections = [
  ...
  _Section(
    heading: '4a. Comision de BeautyCita y retenciones SAT a tu nombre',
    body:
        'BeautyCita cobra exclusivamente las siguientes comisiones de plataforma:\n\n'
        '- 3% por cada reserva en el marketplace (procesamiento de transaccion). '
        'Aplica a toda reserva en red BC; no reembolsable.\n'
        '- 7% + 3% por venta de producto en Punto de Venta (comision de '
        'plataforma 7% reembolsable en devolucion + 3% de procesamiento '
        'no reembolsable).\n\n'
        'Eso es lo unico que cobra BeautyCita. Cualquier otro monto que veas '
        'descontado del pago no es ingreso de BeautyCita.\n\n'
        'Por separado: por ley fiscal mexicana (LISR Art. 113-A, LIVA Art. 18-J), '
        'todo proveedor formal que recibe pagos a traves de plataformas digitales '
        'tiene una obligacion fiscal con el SAT (Servicio de Administracion '
        'Tributaria) sobre cada peso ingresado. Como conveniencia para el '
        'proveedor, BeautyCita entrega al SAT a su nombre — bajo su RFC y '
        'reflejado en su CFDI 4.0 — la mitad de esa obligacion sobre cada '
        'transaccion en red BC:\n\n'
        '- Con RFC registrado: ISR 2.5% + IVA 8% del monto bruto.\n'
        '- Sin RFC: ISR 20% + IVA 16% del monto bruto (la ley nos obliga a '
        'aplicar la tasa maxima sin RFC).\n\n'
        'Estas cantidades NO son ingreso de BeautyCita. Cada peso retenido se '
        'entrega integro al SAT mediante declaraciones informativas mensuales.\n\n'
        'El proveedor sigue siendo responsable de pagar al SAT directamente la '
        'mitad restante de sus obligaciones fiscales (la parte que BeautyCita '
        'no entera a su nombre) para completar el cumplimiento con la autoridad.\n\n'
        'Cada peso retenido es 100% deducible. Si el proveedor reinvierte el '
        'monto retenido en gastos legitimos del negocio (equipo, productos, '
        'capacitacion, mantenimiento), recupera el total al cierre del '
        'ejercicio fiscal. La calculadora de deducciones en el panel del '
        'salon (Impuestos y Deducciones) muestra exactamente cuanto puede '
        'gastar el proveedor para recuperar lo retenido.',
  ),
  _Section(
    ...
    body:
        ...
        'daciones, invite link). Sobre estas transacciones:\n'
        '  - BeautyCita cobra 3% de comision (procesamiento de transaccion).\n'
        '  - Por separado, BeautyCita entrega al SAT a nombre del salon — '
        'bajo su RFC, reflejado en su CFDI 4.0 — la mitad de la obligacion '
        'fiscal del salon (ISR 2.5% + IVA 8% con RFC; 20% + 16% sin RFC) '
        'conforme a LISR Art. 113-A y LIVA Art. 18-J, mediante declaraciones '
        'informativas mensuales. Estos montos no son ingreso de BeautyCita.\n'
        '  - El salon sigue siendo responsable de la mitad restante de sus '
        'obligaciones SAT y debe pagarla directamente.\n\n'
        ...
        '  - BeautyCita NO cobra ninguna comision ni cargo de procesamiento.\n'
        '  - BeautyCita NO entrega ninguna parte al SAT (no toco el dinero).\n'
        ...
        'transacciones al SAT por sus propios medios y de pagar la '
        'totalidad de los impuestos correspondientes.\n\n'
