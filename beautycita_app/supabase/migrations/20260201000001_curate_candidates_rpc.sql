-- =============================================================================
-- Migration: 20260201000001_curate_candidates_rpc.sql
-- Description: RPC function for the curate-results edge function (Step 3).
--              Finds businesses offering a service type within a radius that
--              have available staff slots in a given time window.
-- =============================================================================
