...
class _LandingPageState extends State<LandingPage>
  ...
  Widget _comparisonTable() {
    final rows = [
      ...
      _CompRow('Pagina portfolio', 'Sitio personal', 'Pagina basica', 'Perfil en marketplace', bcType: _CellType.checkText, col2Type: _CellType.plain, col3Type: _CellType.plain),
      _CompRow('Punto de venta', 'GRATIS (7% comision + 3% procesamiento)', '\$250/mes', '2.19% + 0.20 por pago', bcType: _CellType.free, col2Type: _CellType.warn, col3Type: _CellType.warn),
  ...
  Widget _buildForSalons(bool isDesktop, bool isMobile, bool isTablet) {
    final features = [
      ...
      _Feature(Icons.calendar_today_outlined, 'Calendario Inteligente',
        'Sync bidireccional en tiempo real con Google Calendar — evita citas dobles.',
        detailTitle: 'Calendario con Superpoderes',
        detailBullets: [
          'Arrastra y suelta para reagendar o reasignar citas a otro estilista',
          'Sincronizacion bidireccional en tiempo real con Google Calendar — evita citas dobles',
      ...
      _Feature(Icons.desktop_mac_outlined, 'Portfolio Web',
        ...
        detailBullets: [
          'Pagina personal profesional en beautycita.com/p/tu-salon',
      ...
      _Feature(Icons.storefront_outlined, 'Punto de Venta',
        'Vende productos de belleza. Solo 7% comision + 3% procesamiento. Sin mensualidad.',
        ...
        detailBullets: [
          ...
          'Solo 7% de comision (reembolsable en devoluciones) + 3% de procesamiento de transacciones (no reembolsable). Sin mensualidad. Sin setup.',
